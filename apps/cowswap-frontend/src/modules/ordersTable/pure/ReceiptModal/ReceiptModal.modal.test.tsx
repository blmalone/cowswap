...
describe('ReceiptModal', () => {
  ...
  it('renders the filled receipt anatomy and keeps overlay dismissal with the owner primitive', () => {
    ...
    const overlay = screen.getByTestId('drawer-or-dialog')
    const header = screen.getByRole('banner')

    expect(overlay.getAttribute('data-nested')).toBe('true')
    expect(overlay.getAttribute('data-full-screen')).toBe('true')
    expect(overlay.getAttribute('data-title')).toBe('Order receipt')
